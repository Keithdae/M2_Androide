...
public abstract class AbstractStorelessUnivariateStatistic
     ...
     * @see apache.commons.math3.stat.descriptive.UnivariateStatistic#evaluate(double[])
     */
    @Override
     ...
     * @see apache.commons.math3.stat.descriptive.UnivariateStatistic#evaluate(double[], int, int)
     */
    @Override
     ...
     * @throws MathIllegalArgumentException if values is null
     * @see apache.commons.math3.stat.descriptive.StorelessUnivariateStatistic#incrementAll(double[])
     */
     ...
     * @throws MathIllegalArgumentException if values is null
     * @see apache.commons.math3.stat.descriptive.StorelessUnivariateStatistic#incrementAll(double[], int, int)
     */
