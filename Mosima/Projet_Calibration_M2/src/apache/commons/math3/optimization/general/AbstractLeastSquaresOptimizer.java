...
import apache.commons.math3.analysis.DifferentiableMultivariateVectorFunction;
import apache.commons.math3.analysis.FunctionUtils;
import apache.commons.math3.analysis.differentiation.DerivativeStructure;
import apache.commons.math3.analysis.differentiation.MultivariateDifferentiableVectorFunction;
...
import apache.commons.math3.exception.util.LocalizedFormats;
import apache.commons.math3.linear.ArrayRealVector;
import apache.commons.math3.linear.RealMatrix;
import apache.commons.math3.linear.DiagonalMatrix;
import apache.commons.math3.linear.DecompositionSolver;
import apache.commons.math3.linear.MatrixUtils;
import apache.commons.math3.linear.QRDecomposition;
import apache.commons.math3.linear.EigenDecomposition;
import apache.commons.math3.optimization.OptimizationData;
import apache.commons.math3.optimization.InitialGuess;
import apache.commons.math3.optimization.Target;
import apache.commons.math3.optimization.Weight;
import apache.commons.math3.optimization.ConvergenceChecker;
import apache.commons.math3.optimization.DifferentiableMultivariateVectorOptimizer;
import apache.commons.math3.optimization.PointVectorValuePair;
import apache.commons.math3.optimization.direct.BaseAbstractMultivariateVectorOptimizer;
import apache.commons.math3.util.FastMath;
 ...
 * {@link apache.commons.math3.optimization.Target Target} while
 * the number of columns is equal to the dimension of the
 * {@link apache.commons.math3.optimization.InitialGuess InitialGuess}.
 *
...
public abstract class AbstractLeastSquaresOptimizer
     ...
     * apache.commons.math3.optimization.SimpleVectorValueChecker}.
     * @deprecated See {@link apache.commons.math3.optimization.SimpleValueChecker#SimpleValueChecker()}
     */
    @Deprecated
     ...
     * problem dimension.
     * @throws apache.commons.math3.exception.TooManyEvaluationsException
     ...
     * @throws apache.commons.math3.linear.SingularMatrixException
     ...
     * @throws apache.commons.math3.exception.DimensionMismatchException
     * if the start point dimension is wrong.
     * @throws apache.commons.math3.exception.TooManyEvaluationsException
     * if the maximal number of evaluations is exceeded.
     * @throws apache.commons.math3.exception.NullArgumentException if
     ...
     * function.
     * @throws apache.commons.math3.exception.TooManyEvaluationsException if
