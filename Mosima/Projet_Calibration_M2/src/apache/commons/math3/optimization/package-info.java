 ...
 *  <ul>
 *   <li>{@link apache.commons.math3.optim}</li>
 *   <li>{@link apache.commons.math3.fitting}</li>
 *  </ul>
 * </h3>
 *
 * <p>
 ...
 * function:
 * <ul>
 *  <li>{@link apache.commons.math3.optimization.univariate.UnivariateOptimizer
 *      UnivariateOptimizer} for {@link apache.commons.math3.analysis.UnivariateFunction
 *      univariate real functions}</li>
 *  <li>{@link apache.commons.math3.optimization.MultivariateOptimizer
 *      MultivariateOptimizer} for {@link apache.commons.math3.analysis.MultivariateFunction
 *      multivariate real functions}</li>
 *  <li>{@link apache.commons.math3.optimization.MultivariateDifferentiableOptimizer
 *      MultivariateDifferentiableOptimizer} for {@link
 *      apache.commons.math3.analysis.differentiation.MultivariateDifferentiableFunction
 *      multivariate differentiable real functions}</li>
 *  <li>{@link apache.commons.math3.optimization.MultivariateDifferentiableVectorOptimizer
 ...
 * transform a {@link apache.commons.math3.analysis.MultivariateVectorFunction
 * non-differentiable multivariate vectorial function} by converting it to a {@link
 * apache.commons.math3.analysis.MultivariateFunction non-differentiable multivariate
 * real function} thanks to the {@link
 * apache.commons.math3.optimization.LeastSquaresConverter LeastSquaresConverter} helper class.
 * The transformed function can be optimized using any implementation of the {@link
 * apache.commons.math3.optimization.MultivariateOptimizer MultivariateOptimizer} interface.
 * </p>
 *
 * <p>
 ...
 *
 */
package apache.commons.math3.optimization;
