...
package apache.commons.math3.ode.events;
...
public interface EventHandler  {
    ...
    public enum Action {
         ...
         * apache.commons.math3.ode.FirstOrderDifferentialEquations#computeDerivatives}
         * method).</p>
         */
        RESET_DERIVATIVES,
   ...
   * otherwise {@link apache.commons.math3.exception.NoBracketingException
   ...
   *   apache.commons.math3.ode.sampling.StepHandler#handleStep handleStep}
   ...
   * apache.commons.math3.ode.sampling.StepHandler StepHandler} method {@link
   * apache.commons.math3.ode.sampling.StepHandler#handleStep(
   * apache.commons.math3.ode.sampling.StepInterpolator, boolean)
   ...
   * apache.commons.math3.ode.sampling.StepNormalizer StepNormalizer}
   * does for example), user code called by this method and user
   * code called by step handlers may experience apparently out of order values
   * of the independent time variable. As an example, if the same user object
   * implements both this {@link EventHandler EventHandler} interface and the
   * {@link apache.commons.math3.ode.sampling.FixedStepHandler FixedStepHandler}
   ...
   * apache.commons.math3.ode.sampling.StepHandler variable step handlers} and
   * to the size of the fixed step for {@link
   * apache.commons.math3.ode.sampling.FixedStepHandler fixed step handlers}.</p>
