 ...
 */
package apache.commons.math3.geometry.euclidean.twod;
...
import apache.commons.math3.geometry.Vector;
import apache.commons.math3.geometry.euclidean.oned.Euclidean1D;
import apache.commons.math3.geometry.euclidean.oned.IntervalsSet;
import apache.commons.math3.geometry.euclidean.oned.OrientedPoint;
import apache.commons.math3.geometry.euclidean.oned.Vector1D;
import apache.commons.math3.geometry.partitioning.Embedding;
import apache.commons.math3.geometry.partitioning.Hyperplane;
import apache.commons.math3.geometry.partitioning.SubHyperplane;
import apache.commons.math3.geometry.partitioning.Transform;
...
public class Line implements Hyperplane<Euclidean2D>, Embedding<Euclidean2D, Euclidean1D> {
     ...
     * apache.commons.math3.geometry.euclidean.threed.Line class.</p>
     *
     * @param p to check
    ...
    /** Get a {@link apache.commons.math3.geometry.partitioning.Transform
     * Transform} embedding an affine transform.
     * @param transform affine transform to embed (must be inversible
     * otherwise the {@link
     * apache.commons.math3.geometry.partitioning.Transform#apply(Hyperplane)
     * apply(Hyperplane)} method would work only for some lines, and
     * fail for other ones)
     * @return a new transform that can be applied to either {@link
     * Vector2D Vector2D}, {@link Line Line} or {@link
     * apache.commons.math3.geometry.partitioning.SubHyperplane
