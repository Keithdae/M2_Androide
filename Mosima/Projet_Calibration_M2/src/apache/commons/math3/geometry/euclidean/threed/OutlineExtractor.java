 ...
 */
package apache.commons.math3.geometry.euclidean.threed;

import java.util.ArrayList;

import apache.commons.math3.geometry.euclidean.twod.Euclidean2D;
import apache.commons.math3.geometry.euclidean.twod.PolygonsSet;
import apache.commons.math3.geometry.euclidean.twod.Vector2D;
import apache.commons.math3.geometry.partitioning.AbstractSubHyperplane;
import apache.commons.math3.geometry.partitioning.BSPTree;
import apache.commons.math3.geometry.partitioning.BSPTreeVisitor;
import apache.commons.math3.geometry.partitioning.BoundaryAttribute;
import apache.commons.math3.geometry.partitioning.RegionFactory;
            ...
            if (FastMath.abs(scal) > 1.0e-3) {
                ...
                for (Vector2D[] loop : vertices) {
                    ...
                    while (current < loop.length) {
                        ...
                        final apache.commons.math3.geometry.euclidean.twod.Line line =
                            new apache.commons.math3.geometry.euclidean.twod.Line(pPoint, cPoint);
                        ...
                        if (closed || (previous != 1)) {
                            ...
                            final apache.commons.math3.geometry.euclidean.twod.Line l =
                                new apache.commons.math3.geometry.euclidean.twod.Line(pPoint, angle);
                        ...
                        if (closed || (current != (loop.length - 1))) {
                            ...
                            final double angle = line.getAngle() + 0.5 * FastMath.PI;
                            final apache.commons.math3.geometry.euclidean.twod.Line l =
                                new apache.commons.math3.geometry.euclidean.twod.Line(cPoint, angle);
