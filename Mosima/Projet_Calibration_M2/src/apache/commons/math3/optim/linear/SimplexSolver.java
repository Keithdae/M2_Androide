...
import apache.commons.math3.exception.TooManyIterationsException;
 ...
 * apache.commons.math3.optim.MaxIter MaxIter} as parameter in the call of {@link
 * #optimize(apache.commons.math3.optim.OptimizationData...) optimize(OptimizationData...)},
