...
import Model_Calibration.SimulatedAnnealing.TeacherSimulatedAnnealing;
...
public class AnnealingScheme
{
	...
	public void anneal()
	{
		...
		for (;;)
		{
			...
			if(TeacherSimulatedAnnealing.stopannealingSchemme == true){
				break;
			}
			loopLevel++;
